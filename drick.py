...
######### Reload - 27/03/24 v1.0 ##########
#   Desenvolvido por Wandrew Tischler     #
######## DRICK FRAMEWORK PROJECT ##########
...
def ping():
	...
	if response == 0:
		#c1 = "\033[32m ✓ \033[0;0m"
		print ("\033[32m ✓ \033[0;0m", host, "está online.\n")
	else:
		print ("\033[31m X \033[0;0m", host, "está offline ou inacessível.\n")
...
listag = ["kkefkwfkwfgekgk ","Navegue com segurança muitos querem te ver exposto.", "Não compre terrenos na lua.", "Olá meu nome é Wandrew e atualmente tenho 18 anos. Oi futuro.", "Não se julgue quando não precisa, tente se divertir quando possível.", "Use o comando /limpar.", "Se você se torna um mago quando empunha uma varinha magica, você também se torna um hacker na posse desse programa.", "Obrigado pela preferência.", "Hackers gostam de feriados?", "Beba agua.", "Use o Hórus para adquirir endereços IP online com especificação de programas, portas e versões operando na rede de computadores privada ou global.", "777 ", "Não use com moderação.", "O código fonte está cheio de gambiarras, más está rodando.", "Cuidado, você pode estar sendo espionado(a) agora.", "666", "888", "...", "Oi", "Preciso dizer que não nos responsabilizamos pelo uso indevido?"]
...
while x == True:
	...
	# Trata entradas direras
		...
		print("\n Drick Framework é um pacote de software abrangente que reúne diversos algoritmos essenciais para a execução eficiente de testes de penetração e análise de sistemas ou redes.\n")
